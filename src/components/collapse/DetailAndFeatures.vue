    ...
    <el-collapse class="collapse collapse-detail" v-model="activeDetail">
      <el-collapse-item class="collapse-item" :title="$t('market-detail.title-add')" name="1">
        <div v-for="item in metaDataList" :key="item.id" class="content-item">
          ...
          <span class="value" v-else>{{ item.metaValue }}</span>
        </div>
      </el-collapse-item>
    </el-collapse>
    <el-collapse class="collapse collapse-detail" v-model="activeFeatures">
      <el-collapse-item class="collapse-item" :title="$t('market-detail.title-feature')" name="1">
        <div v-for="item in getFeatureListExist" :key="item.id" class="content-features">
          <base-icon icon="icon-checked" size="20" />
...
<script lang="ts">
  ...
  const bcMarketHome = namespace('bcMarketHome')
