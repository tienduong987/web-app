<template>
  <div class="container be-flex detail-content">
    <div class="detail-content__left">
      <div class="header" v-if="isShowCompProduct">
        ...
        <div class="be-flex ju-between">
          ...
          <div class="property-id">
            <p>
              Property ID: <b>{{ data.product.propertyCode }}</b>
            </p>
          </div>
        </div>
      </div>
      ...
      <detail-block v-if="!isShowCompProduct" :id="2" :blockList="data.blockList" />

      <detail-investor v-if="!isShowCompProduct && data.investor" :investor="data.investor" :id="3" />

      <detail-attachment :attachmentList="data.attachmentList" :id="4" />
    ...
    <!-- <div class="detail-content__right">
      <detail-target />
      <detail-trans />
      <detail-analytic v-if="isShowCompProduct" />
    </div> -->
  </div>
</template>
