    ...
    <div class="container" style="display:flex">
      ...
      <div class="beach-left">
        ...
        <div class="arrows">
          ...
          <span class="dots">
            <div v-for="item in 3" :key="item" :class="item == isActive ? 'dot active' : 'dot'" @click="gotoItem(item)"></div>
            <!-- <div :class="this.isActive == 2 ? 'dot active' : 'dot'" @click="goToItemSecond"></div>
            <div :class="this.isActive == 3 ? 'dot active' : 'dot'" @click="goToItemThirst"></div>
            <div :class="this.isActive == 4 ? 'dot active' : 'dot'" @click="goToItemFourth"></div> -->
          </span>
...
<script lang="ts">
  ...
  export default class HomeBanner extends Vue {
    ...
    items = [
      {
        link: '../../../../icons/png/product-img1.png',
      ...
      {
        link: '../../../../icons/png/product-img2.png',
      ...
      {
        link: '../../../../icons/png/product-img3.png',
